...
method printIns(ins:ins)
{
    match ins
        ...
        case BSwap64(dst)    => print ("  bswap "); printOprnd64(dst); print("\n");
        ...
        case MOVD(dst, src) => print ("  movd "); printXmmOprnd(dst); print(", "); printOprnd(src); print("\n");
        ...
        case POR(dst, src)            => print ("  por "); printOprnd(dst); print(", "); printOprnd(src); print("\n");
        case PSLLDQ(dst, imm8)        => print ("  pslldq "); printOprnd(dst); print(", "); printOprnd(imm8); print("\n");
