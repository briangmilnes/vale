...
function{:opaque} seq0() : seq<uint64>
    ensures (var x := seq0(); |x| == 0)
{
    []
}

function{:opaque} seq1(a:uint64) : seq<uint64>
    ensures (var x := seq1(a); |x| == 1 && x[0] == a)
{
    [a]
}

function{:opaque} seq2(a:uint64, b:uint64)  : seq<uint64>
    ensures (var x := seq2(a, b); |x| == 2 && x[0] == a && x[1] == b)
{
    [a, b]
}

function{:opaque} seq3(a:uint64, b:uint64, c:uint64)  : seq<uint64>
    ensures (var x := seq3(a, b, c); |x| == 3 && x[0] == a && x[1] == b && x[2] == c)
{
    [a, b, c]
}

function{:opaque} seq4(a:uint64, b:uint64, c:uint64, d:uint64) : seq<uint64>
    ensures (var x := seq4(a, b, c, d); |x| == 4 && x[0] == a && x[1] == b && x[2] == c && x[3] == d)
{
    [a, b, c, d]
}

function{:opaque} seq5(a:uint64, b:uint64, c:uint64, d:uint64, e:uint64) : seq<uint64>
...
function{:opaque} seq6(a:uint64, b:uint64, c:uint64, d:uint64, e:uint64, f:uint64) : seq<uint64>
    ensures (var x := seq6(a, b, c, d, e, f); |x| == 6 && x[0] == a && x[1] == b && x[2] == c && x[3] == d && x[4] == e && x[5] == f)
{
    [a, b, c, d, e, f]
}

function{:opaque} seq7(a:uint64, b:uint64, c:uint64, d:uint64, e:uint64, f:uint64, g:uint64) : seq<uint64>
...
function{:opaque} seq8(a:uint64, b:uint64, c:uint64, d:uint64, e:uint64, f:uint64, g:uint64, h:uint64):seq<uint64>
